...
//@ts-ignore | This is added to some function and var because typescript thinks all the files are part of a block or global scope when infact there loaded into diffrent browser windows.
function main() {
    const target_title = document.getElementsByClassName('svelte-18bi8gg lcd lcd__music')[0].shadowRoot.querySelectorAll('.lcd-meta__primary > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1)')[0];
    const observer = new MutationObserver((_mutationList, _observer) => { scriptGetVideo(); });
    info.extra.service = 'applemusic';
...
awaitElementLoad(() => { return document.getElementsByClassName('svelte-18bi8gg lcd lcd__music')[0].shadowRoot.querySelectorAll('.lcd-meta__primary > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1)')[0]; }, main);